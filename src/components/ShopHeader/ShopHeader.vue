<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleShowShow">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span>约 {{info.delivertTime}} 分钟</span>
        </span>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopShow">
        ...
        <span class="content-tag">
          ...
          <div class="mask-footer" @click="toggleShowShow">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supporShow">
